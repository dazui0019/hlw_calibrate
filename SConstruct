...
if os.getenv('RTT_ROOT'):
    ...
    RTT_ROOT = os.path.normpath(os.getcwd() + '/middleware/rt-thread')
...
if os.path.exists(SDK_ROOT + '/middleware/libraries'):
    libraries_path_prefix = SDK_ROOT + '/middleware/libraries'
else:
